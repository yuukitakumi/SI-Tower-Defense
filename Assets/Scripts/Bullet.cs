...
public class Bullet : MonoBehaviour
{
    ...
    //fixedupdate adalah update yg lebih konsisten jeda pemanggilannya
    //cocok digunakan juka karakter memiliki physic (rigidbody dll)
